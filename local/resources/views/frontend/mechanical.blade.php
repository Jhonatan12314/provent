        ...
        <div class="row">
            ...
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  <li><a href="meterial">meterial engineering</a></li>
                  <li><a href="agricultural">agricultural processing</a></li>
                  <li class="active"><a href="mechanical">Mechanical engineering</a></li>
                  <li><a href="chemical">chemical research</a></li>
                  <li><a href="power">power and energy</a></li>
                  <li><a href="oil">Oil and lubricant</a></li>
                  <li><a href="alternate">alternate energy</a></li>
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active">
              <div class="image-box clearfix"><img src="public/frontend/images/services/mechanical_Engineering_01.jpg" alt=""></div>
              <div class="sec-title">
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="public/frontend/images/services/mechanical_Engineering_02.jpg" alt="Awesome Image"></div>
                <div class="text-box">
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="public/frontend/images/services/mechanical_Engineering_03.jpg" alt="Awesome Image"></div>
                <div class="text-box">
