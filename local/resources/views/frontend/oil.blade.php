        ...
        <div class="row">
            ...
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  ...
                  <li><a href="chemical">chemical research</a></li>
                  <li><a href="power">power and energy</a></li>
                  <li class="active"><a href="oil">Oil and lubricant</a></li>
                  <li><a href="alternate">alternate energy</a></li>
                </ul>
              </div>
            </div>
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active">
              <div class="image-box clearfix"><img src="public/frontend/images/services/Oil_01.jpg" alt=""></div>
              <div class="sec-title">
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="public/frontend/images/services/Oil_02.jpg" alt="Awesome Image"></div>
                <div class="text-box">
                  <h2>Storage Tanks</h2>
