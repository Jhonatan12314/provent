      ...
      <div class="container clearfix">
        <div class="row">
          <div class="single-side-left">
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  <li><a href="meterial">meterial engineering</a></li>
                  <li class="active"><a href="agricultural">agricultural processing</a></li>
                  <li><a href="mechanical">Mechanical engineering</a></li>
                  <li><a href="chemical">chemical research</a></li>
                  <li><a href="power">power and energy</a></li>
                  <li><a href="oil">Oil and lubricant</a></li>
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active"><img src="public/frontend/images/services/Agricultural_Processing_01.jpg" alt="">
              <div class="sec-title">
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="public/frontend/images/services/Agricultural_Processing_02.jpg" alt="Awesome Image"></div>
                <div class="text-box">
                  <h2>Our Research </h2>
              ...
              <div class="image-caption-box">
                ...
                <div class="caption-box-img"><img src="public/frontend/images/services/Agricultural_Processing_03.jpg" alt="Awesome Image"></div>
              </div>
            </div>
          </div>
        </div>
