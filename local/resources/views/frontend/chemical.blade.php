    ...
    <section class="breadcumb-wrapper">
      <div class="container clearfix">
        <ul class="breadcumb">
          ...
          <li><span>chemical research</span></li>
        </ul>
      </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  ...
                  <li><a href="agricultural">agricultural processing</a></li>
                  <li><a href="mechanical">Mechanical engineering</a></li>
                  <li class="active"><a href="chemical">chemical research</a></li>
                  <li><a href="power">power and energy</a></li>
                  <li><a href="oil">Oil and lubricant</a></li>
                  <li><a href="alternate">alternate energy</a></li>
                </ul>
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active">
              <div class="image-box clearfix"><img src="public/frontend/images/services/chemical_research_01.jpg" alt=""><img src="public/frontend/images/services/chemical_research_02.jpg" alt="" class="pull-right"></div>
              <div class="sec-title">
                <h2><span>chemical research</span></h2>
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="public/frontend/images/services/chemical_research_03.jpg" alt="Awesome Image"></div>
                <div class="text-box">
