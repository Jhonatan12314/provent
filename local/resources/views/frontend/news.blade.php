          ...
          <div class="col-md-8 col-sm-12 pull-right">
            ...
            <div class="single-post-wrapper">
              ...
              <article class="single-blog-post img-cap-effect">
                ...
                <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, co nsect etur, adipisci velit.</p><a href="news-details" class="read-more btn submit">Read More</a>
              </article>
              <!-- News 2-->
              <article class="single-blog-post img-cap-effect">
