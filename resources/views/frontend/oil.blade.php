        ...
        <div class="row">
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active">
              <div class="image-box clearfix"><img src="frontend/images/services/Oil_01.jpg" alt=""></div>
              <div class="sec-title">
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="frontend/images/services/Oil_02.jpg" alt="Awesome Image"></div>
                <div class="text-box">
                  <h2>Storage Tanks</h2>
